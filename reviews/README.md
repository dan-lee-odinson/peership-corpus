...
| [`03-isonomia-commons/`](03-isonomia-commons/) | III. *The Isonomia Commons* | 2 audit trails — **five formal adversarial cycles** on the whitepaper, plus the preprint's publication audit. But its review prompt is a **reconstruction, not a transcript**, and its verbatim review texts are held. Reviewed hard; the **least checkably** of the five. See [`REVIEW_PROVENANCE.md`](REVIEW_PROVENANCE.md). |
